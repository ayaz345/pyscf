...
print(f'<core1|core2> SVD eig = {numpy.linalg.svd(score)[1]}')
print(f'det(<core1|core2>)    = {numpy.linalg.det(score)}')
print(f'<CAS1|CAS2> SVD eig = {numpy.linalg.svd(scas)[1]}')
print(f'det(<CAS1|CAS2>)    = {numpy.linalg.det(scas)}')
