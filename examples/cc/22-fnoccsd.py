...
# print FNO error
print(
    f"Default FNO error (using {mycc.nmo - mycc.nocc}/{nvir} vir orbs) =",
    mycc.e_corr - -0.3170511898840137,
)

# lower NO occupation threshold
mycc = cc.FNOCCSD(mf, thresh=1e-5).run()
print(
    f"Lower threshold FNO error (using {mycc.nmo - mycc.nocc}/{nvir} vir orbs) =",
    mycc.e_corr - -0.3170511898840137,
)
